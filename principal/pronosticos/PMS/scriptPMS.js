...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    function calcularPromedioMovilSimple(demanda, N) {
      var pronostico = [];
    ...
    var pronostico = calcularPromedioMovilSimple(demanda, N);
  ...
  function Guardar() {
    ...
    html2canvas(container, {
      ...
      var storageRef = firebase.storage().ref('imagesPMS/' + nombreImagen + '.png');
